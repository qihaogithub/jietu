<template>
  ...
  <div class="container-water-fall">
    <waterfall :col="col" :data="data" @loadmore="loadmore" :gutterWidth="10">
      <div class="cell-item" v-for="(item, index) in data" :key="index" @click="showImageDetails(index)">
    ...
    <detail v-if="selectedImage" :selectedImage="selectedImage" @CloseImageDetails="CloseImageDetails" />
